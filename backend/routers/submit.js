...
router.post('/', function(req, res) {
    ...
    if(name!=null && name.trim()!='' && instructions!=null && instructions.trim()!='' && category!=null && ingredients!=null){
        db.serialize(() => {
            ...
            db.run(insertRecipeQuery, [name, instructions, category], function(err) {
                ...
                ingredients.forEach(ingredient => {
                    ...
                    if(name!=null && name.trim()!='' && quantity!=null && !isNaN(quantity) && Number(quantity) >= 0 && unit!=null && unit.trim()!=''){
